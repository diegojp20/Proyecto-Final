...
<body>
    ...
    <div class="mesaje">
        ...
        <br>
        <a href="listaiInventario.php" class="reg">Regregar</a>
    </div>
</body>

</html>
<!-- mysqli_connect("localhost", "root", "", "brunosac"); -->
...
if (php_sapi_name() != "cli") {
    echo '<div class="reporte" style="font-family: monospace;">';
}
